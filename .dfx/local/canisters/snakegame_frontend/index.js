...
import { idlFactory } from './snakegame_frontend.did.js';
export { idlFactory } from './snakegame_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNAKEGAME_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./snakegame_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the snakegame_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./snakegame_frontend.did.js")._SERVICE>}
 */
export const snakegame_frontend = createActor(canisterId);
