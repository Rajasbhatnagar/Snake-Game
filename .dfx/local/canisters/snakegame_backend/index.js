...
import { idlFactory } from './snakegame_backend.did.js';
export { idlFactory } from './snakegame_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SNAKEGAME_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./snakegame_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the snakegame_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./snakegame_backend.did.js")._SERVICE>}
 */
export const snakegame_backend = createActor(canisterId);
