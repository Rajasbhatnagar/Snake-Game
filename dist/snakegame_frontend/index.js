...
/***/ "./src/declarations/snakegame_backend/index.js":
/*!*****************************************************!*\
  !*** ./src/declarations/snakegame_backend/index.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   idlFactory: () => (/* reexport safe */ _snakegame_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   snakegame_backend: () => (/* binding */ snakegame_backend)
/* harmony export */ });
...
/* harmony import */ var _snakegame_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./snakegame_backend.did.js */ "./src/declarations/snakegame_backend/snakegame_backend.did.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_snakegame_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const snakegame_backend = createActor(canisterId);


/***/ }),

/***/ "./src/declarations/snakegame_backend/snakegame_backend.did.js":
/*!*********************************************************************!*\
  !*** ./src/declarations/snakegame_backend/snakegame_backend.did.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!*********************************************!*\
  !*** ./src/snakegame_frontend/src/index.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_snakegame_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/snakegame_backend */ "./src/declarations/snakegame_backend/index.js");
...
Component.Stage = function (canvas, conf, callback) {
  ...
  _declarations_snakegame_backend__WEBPACK_IMPORTED_MODULE_0__.snakegame_backend
    .highestScoreHandler()
    .then((highestScore) => {
...
Game.Draw = function (context, snake) {
  this.drawStage = async function () {
    ...
    if (!snake.stage.isGameOver && this.collision(nx, ny)) {
      ...
      await _declarations_snakegame_backend__WEBPACK_IMPORTED_MODULE_0__.snakegame_backend.updateHighestScore(snake.stage.score);

      // Fetch and update the highest score after the game ends
      try {
        const newHighestScore =
          await _declarations_snakegame_backend__WEBPACK_IMPORTED_MODULE_0__.snakegame_backend.highestScoreHandler();
